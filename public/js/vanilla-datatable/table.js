...
(function(root, factory) {
    ...
    var defaultConfig = {
        ...
        labels: {
            placeholder: "Example: DE_0_238", // The search input placeholder
            perPage: "{select} listings per page", // per-page dropdown label
            noRows: "Listing not found", // Message shown when there are no search results
